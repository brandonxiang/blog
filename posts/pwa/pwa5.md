...
![浏览器的兼容性](https://brandonxiang.top/img/caniuse-serviceworker.png)
...
![安卓微信浏览器的支持情况](https://brandonxiang.top/img/android-serviceworker.png)
...
![苹果safari已开始支持service worker](https://brandonxiang.top/img/safari-serviceworker.png)
...
> 结合[Vue 笔记八：多页面打包框架](https://brandonxiang.top/blog/vue8)的多页面打包框架，我添加上 precache 的功能（以后计划替换成为 workbox），实现多页面的 service worker 框架，github 的地址是[https://github.com/brandonxiang/mpa-pwa](https://github.com/brandonxiang/mpa-pwa)
...
![workbox file structure](https://brandonxiang.top/img/workbox-file-structure.png)
